...
function createIframe(target) {
  ...
  singleTonIframe.style.minHeight = "600px";  // Start with a larger height
  singleTonIframe.style.height = "auto";      // Auto-expand
  singleTonIframe.style.border = "0";
  singleTonIframe.style.overflow = "visible"; // Allow full content display
